...
public class UserController {
    ...
    public AuthorEntity addFavAuthor(@RequestBody AddFavAuthorRequest addFavAuthorRequest) {
    ...
    public GenreEntity addFavGenre(@RequestBody AddFavGenreRequest addFavGenreRequest) {
